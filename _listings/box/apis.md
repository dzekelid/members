...
- name: Box
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/members/master/_listings/box/users-user-id-memberships-get.md
- name: Box Delete Membership
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/members/master/_listings/box/group-memberships-group-membership-id-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/members/master/_listings/box/group-memberships-group-membership-id-delete-postman.md
x-common:
- type: x-base
